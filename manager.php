...
/* Image hover effect to indicate it's clickable */
.small-image {
    cursor: pointer;
}
...
<div class="sidebar">
    <ul>
		...
		<li><a href="view_leave_requests.php">Leave Requests</a></li>
...
<div class="main-content">
    ...
    <?php if ($page == 'dashboard') { ?>
        ...
        <div class="stat-box-container">
            <div class="stat-box">
			<a href="manager.php?page=employee_details" style="text-decoration: none; color: inherit;">
                <h3>Total Employees</h3>
                <p><?php echo $userCount; ?></p>
            </div>

            <div class="stat-box">
			<a href="manager.php?page=view_attendance" style="text-decoration: none; color: inherit;">
    ...
    <tbody>
        ...
        if ($loginResult->num_rows > 0) {
            while ($row = $loginResult->fetch_assoc()) {
                ...
                echo "<td><img src='" . htmlspecialchars($row['photo_url']) . "' alt='User Photo' width='50' class='small-image' onclick='openModal(this.src)'></td>";
                echo "</tr>";
            }
        } else {
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='edit_employee.php?id=" . $row['employee_id'] . "' class='edit-btn'>Edit</a></td>"; // Edit button link
                echo "</tr>";
            }
        } else {
